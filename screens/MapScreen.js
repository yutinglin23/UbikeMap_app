      ...
      <Box flex={1}>
         ...
         >
            {(zoomRatio > 0.14) && metro.map((site) => (
               ...
               >
                  <Center bg="#0B5CD6" borderRadius={60} p={3 * zoomRatio} borderWidth={2 * zoomRatio} borderColor="black">
                     <MaterialCommunityIcons name={"train"} size={30 * zoomRatio} color="white" />
                  </Center>
               </Marker>
            ))}
